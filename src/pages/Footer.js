    ...
    return (
        <div>
            <Box sx={{ backgroundColor: "#CA9D7A" }}>
                <Container >
                    <Box sx={{ backgroundColor: "#CA9D7A", display: "flex", alignItems: "center", width: "100%", }}>
                        <Grid container spacing={0} sx={{ padding: "25px 25px 25px 25px" }}>
                            <Grid item xl={3} md={3} lg={3} sm={12} sx={{ textAlign: "start" }}>
                            ...
                            <Grid item xl={3} md={3} lg={3} sm={12} sx={{ textAlign: "start", alignItems: "center" }}>
                                <Box sx={{ display: "flex", borderRight: "solid 1px #ffffff2b", gap: "10px", padding: "10px" }}>
